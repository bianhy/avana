...
namespace Avana\System\Libraries\Database;

use Avana\System\Libraries\Database\Driver\Processor;
use Avana\System\Libraries\DataConfigLoader;
...
class DB
{
    ...
    public function __construct()
    {
        ...
        $container->bind('db.connector.mysql_hash',  'Avana\System\Libraries\Database\Driver\Connector');
        $container->bind('db.connection.mysql_hash', 'Avana\System\Libraries\Database\Driver\Connection');
