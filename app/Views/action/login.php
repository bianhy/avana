...
<head>
    ...
    <title>登录</title>
    <link rel="stylesheet" href="<?= LOGIN_STATIC;?>css/normalize.css">
    <link rel="stylesheet" href="<?= LOGIN_STATIC;?>css/login.css">
    <link rel="stylesheet" href="<?= LOGIN_STATIC;?>css/sign-up-login.css">

    <link rel="stylesheet" href="<?= AVANA_STATIC; ?>css/font-awesome.4.6.0.css" type="text/css">
    <link rel="stylesheet" href="<?= LOGIN_STATIC; ?>css/inputEffect.css" />
    <link rel="stylesheet" href="<?= LOGIN_STATIC; ?>css/verifyCode.css" />
    <link rel="stylesheet" href="<?= LOGIN_STATIC; ?>css/tooltips.css" />
    <link rel="stylesheet" href="<?= LOGIN_STATIC; ?>css/spop.min.css" />

    <script src="<?= LOGIN_STATIC; ?>js/jquery-1.10.2.js"></script>
    <script src="<?= LOGIN_STATIC; ?>js/snow.js"></script>
    <script src="<?= LOGIN_STATIC; ?>js/jquery.pure.tooltips.js"></script>
    <script src="<?= LOGIN_STATIC; ?>js/verifyCode.js"></script>
    <script src="<?= LOGIN_STATIC; ?>js/spop.min.js"></script>
    <script src="<?= LOGIN_STATIC; ?>js/md5.js"></script>
    <script>
        (function() {
        ...
        function login(){//登录
            ...
            //用户名只能是15位以下的字母或数字
            var regExp = new RegExp("^1[34578]{1}[0-9]{9}$");
            ...
            $.ajax({
                type: "POST",
                url: "/login",
                data: {mobile:username, password:md5(password)},
                dataType: "json",
                success: function(data) {
                    if (data.code == 200) {
                        spop({
                            template: '<h4 class="spop-title">登录成功</h4>即将于3秒后返回首页',
                            position: 'top-center',
                            style: 'success',
                            autoclose: 3000,
                            onOpen: function () {
                                ...
                                var showPop = setInterval(function () {
                                    ...
                                    $('.spop-body').html('<h4 class="spop-title">登录成功</h4>即将于' + second + '秒后返回首页');
                                    second--;
                                }, 1000);
                            },
                            onClose: function () {
                        ...
                        spop({
                            template: '<h4 class="spop-title">登录失败</h4>'+data.msg,
                            position: 'top-center',
                            style: 'error',
                            autoclose: 3000,
                        });
        ...
        function register(){
            ...
            $.ajax({
                type: "POST",
                url: "/action/register",
                data: {mobile:username, password:md5(password), verifyCode:code},
                dataType: "json",
                success: function(data){
                    if (data.code == 200) {
                        spop({
                            template: '<h4 class="spop-title">注册成功</h4>即将于3秒后返回首页',
                            position: 'top-center',
                            style: 'success',
                            autoclose: 3000,
                            onOpen : function(){
                                ...
                                var showPop = setInterval(function(){
                                    ...
                                    $('.spop-body').html('<h4 class="spop-title">注册成功</h4>即将于'+second+'秒后返回首页');
                                    second--;
                                },1000);
                            },
                            onClose : function(){
                        ...
                        spop({
                            template: '<h4 class="spop-title">注册失败</h4>+data.msg',
                            position: 'top-center',
                            style: 'success',
                            autoclose: 3000,
                        });
    ...
    <style type="text/css">
        ...
        body{
            ...
            background-image: url(<?= LOGIN_STATIC; ?>images/snow.jpg);
        ...
        <div class="login sign-out-htm">
            <form action="#" method="post" class="container offset1 loginform">
                ...
                <div class="pad input-container">
                    <section class="content">
							<span class="input input--hideo">
								<input class="input__field input__field--hideo" type="text" id="forget-username" autocomplete="off" placeholder="请输入手机号"/>
